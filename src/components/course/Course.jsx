  ...
  return (
    <>
      ...
      <form
        ...
        className="text-center py-8 pt-20 grid grid-cols-1"
      >
        ...
        <div className="flex justify-center ">
          <button
            type="submit"
            className="mt-6 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded "
          >
            Submit
          </button>
        </div>
